...
class News(Gtk.Grid):
    def __init__(self):
        ...
        for count, item in enumerate(constants.category, start=1):
    ...
    def backspace_pressed(self, entry):
...
class Fixtures(Gtk.Grid):
    def __init__(self):
        ...
        self.buttonPrevious = Gtk.Button("_Previous")
        self.buttonPrevious.set_use_underline(True)
        ...
        self.buttonNext = Gtk.Button("_Next")
        self.buttonNext.set_use_underline(True)

...
class Stadium(Gtk.Grid):
    def __init__(self):
        ...
        self.buttonRevert = Gtk.Button("_Revert")
        self.buttonRevert.set_use_underline(True)
        self.buttonRevert.connect("clicked", self.revert_upgrade)
        buttonbox.add(self.buttonRevert)
        self.buttonConfirm = Gtk.Button("_Build")
        self.buttonConfirm.set_use_underline(True)

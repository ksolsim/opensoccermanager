...
def rejection(negotiationid, transfer, index):
    ...
    message = (("Your enquiry into the availability of %s has been turned down,\nas the club does wish to transfer him at this moment in time." % (name), "The transfer negotiations for %s have broken down, as\nthe club believe he is worth more than has been offered." % (name), "%s has rejected the contract offered\nto him as he wishes to stay at his current club." % (name)), ("The enquiry lodged into the loan availability of %s has been\nrejected as the club does not wish to loan him." % (name), "Negotiations for the loan move of %s have been cancelled as the club\ndo not wish to loan for that length of time." % (name)))

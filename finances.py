...
class Finances(Gtk.Grid):
    def __init__(self):
        ...
        self.buttonApply = Gtk.Button("_Borrow")
        self.buttonApply.set_use_underline(True)
        ...
        buttonbox = Gtk.ButtonBox()
        buttonbox.set_layout(Gtk.ButtonBoxStyle.END)
        self.buttonRepay = Gtk.Button("_Repay")
        self.buttonRepay.set_use_underline(True)
        ...
        self.buttonApplyOverdraft = Gtk.Button("_Apply")
        self.buttonApplyOverdraft.set_use_underline(True)
        ...
        self.buttonGrant = Gtk.Button("_Apply")
        self.buttonGrant.set_use_underline(True)
        ...
        buttonFloat = Gtk.Button("_Float")
        buttonFloat.set_use_underline(True)
    ...
    def update_finances(self, index):
        if index == 0:
            ...
            self.labelLoan.set_text("%s" % (amount))
        elif index == 1:
            amount = display.currency(game.overdraft.amount)
            self.labelOverdraft.set_text("%s" % (amount))
    ...
    def update_amount_button(self, spinbutton):
        ...
        self.labelWeekly.set_text("%s" % (repayment))
    ...
    def run(self):
        ...
        self.labelOverdraftMaximum.set_text("%s" % (amount))
...
class Accounts(Gtk.Grid):
    ...
    def run(self):
        ...
        for item in range(0, 9):
            ...
            self.labels_week[item].set_text("%s" % (amount))

            amount = display.currency(club.accounts[item][1])
            self.labels_season[item].set_text("%s" % (amount))

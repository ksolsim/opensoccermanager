...
class Players(Gtk.Grid):
    def __init__(self):
        ...
        buttonFilter.set_use_underline(True)
        buttonFilter.connect("clicked", self.filter_dialog)
        buttonbox.add(buttonFilter)
        self.buttonReset = Gtk.Button("_Reset")
        self.buttonReset.set_use_underline(True)
...
class Shortlist(Gtk.Grid):
    def __init__(self):
        ...
        self.buttonRemove = Gtk.Button("_Remove")
        self.buttonRemove.set_use_underline(True)
